            ...
            <div class="collapse" id="page-layouts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item d-none d-lg-block">
                    <a class="nav-link active" href="almacen">STOCK Almacen</a>
                </li>
                <li class="nav-item d-none d-lg-block">
                    <a href="vt" class="nav-link active">Vender</a>
                </li>
                <li class="nav-item"> 
                    <a href="productos" class="nav-link active">Añadir y modificar productos</a>
                </li>
               
                <li class="nav-item d-none d-lg-block">
                    <a href="h" class="nav-link active">Historial de ventas</a>
                </li>
              </ul>
            </div>
          </li>
